...
import { assets, servicespictures, serviceDetails } from "../assets/assets";
...
const processSteps = [
  ...
  },
  {
    ...
    answer:
      "We prepare a project brief and conduct site analysis. This helps define spatial requirements, timelines, and design direction before concept development begins.",
  },
  {
    question: "How is the design developed?",
    answer:
      "We create concept designs, space planning layouts, and 3D schematic visuals. Your feedback is incorporated until the design direction is approved.",
  },
  {
    question: "Do you provide technical drawings?",
    answer:
      "Yes. After concept approval, we prepare detailed architectural drawings, BIM models, and documentation suitable for approvals and construction.",
  },
  {
    question: "How do payments work?",
    answer:
      "Payments are structured in stages aligned with project milestones such as concept design, design development, and documentation.",
  },
  {
    question: "Do you assist during construction?",
    answer:
      "We can provide construction coordination, site visits, and design clarification to ensure the project is built exactly as designed.",
  },
];
...
const Architecture = () => {
  ...
  const categories = ["Architecture", "Interior Design", "Landscaping"];
  ...
  const filteredImages = Array.isArray(servicespictures)
    ? servicespictures.filter((item) => item.title === selectedCategory)
    : [];
  ...
  const serviceDetail =
    serviceDetails[selectedCategory]?.fullText ||
      ...
      >
        <div className="absolute inset-0 bg-black/50 flex flex-col justify-center px-10 lg:px-24 text-white">
          ...
          <p className="max-w-2xl text-sm sm:text-lg">
            Crafting innovative, functional and sustainable architectural
            solutions powered by modern technologies and African design
            excellence.
          </p>
        </div>
      </section>
...
<div className="text-center mt-10 px-10 lg:px-24">
  ...
  <p className="text-gray-400 mt-5 mb-6">
    Delivering excellence across interior design, architecture, and landscape
    planning.
  </p>
</div>
...
<section className="px-10 lg:px-24 pb-1 py-16 bg-transparent">
  <div className="flex flex-col md:flex-row justify-center items-start space-x-0 md:space-x-10 lg:space-x-16">
    ...
    <div className="flex flex-col items-center max-w-md w-full md:w-auto mb-6 md:mb-0 mt-0">
      ...
      <h3 className="text-lg font-normal mt-4">Interior Design</h3>
    ...
    <div className="flex flex-col items-center max-w-md w-full md:w-auto mb-6 md:mb-0 mt-10">
      ...
      <h3 className="text-lg font-normal mt-4">Architecture</h3>
      <div className="text-xl leading-none text-gray-400 font-light mt-1">|</div>
    ...
    <div className="flex flex-col items-center max-w-md w-full md:w-auto mt-20">
      ...
      <h3 className="text-lg font-normal mt-4">Landscaping</h3>
      <div className="text-xl leading-none text-gray-400 font-light mt-1">|</div>
    ...
    {summaryText}
      ...
      <section className="text-center mt-15 px-10 lg:px-24">
        <h2 className="text-3xl lg:text-4xl font-semibold mb-4 text-white">
          Talk to Us About Your Dream House
        </h2>
        <p className="text-sm text-gray-300 mb-10">
          Let’s bring your vision to life with bespoke architectural design tailored to you.
        </p>
