...
import {
  servicespicturesConstruction,
  serviceDetailsConstruction,
} from "../assets/assets";
...
const processSteps = [
  ...
  },
  {
    ...
    answer:
      "We prepare a project brief and conduct site analysis. This helps define project scope, timelines, and construction requirements before work begins.",
  },
  {
    question: "How is the construction planned?",
    answer:
      "We create detailed construction plans, schedules, and material specifications. Your input is incorporated to ensure your vision is fully realized.",
  },
  {
    question: "Do you provide technical drawings and reports?",
    answer:
      "Yes. After planning, we prepare all necessary construction drawings, structural plans, and documentation suitable for approvals and on-site execution.",
  },
  {
    question: "How do payments work?",
    answer:
      "Payments are structured in stages aligned with project milestones such as planning, groundwork, construction, and handover.",
  },
  {
    question: "Do you assist during project execution?",
    answer:
      "We provide on-site supervision, progress monitoring, and quality assurance to ensure the project is built exactly as planned.",
  },
];
...
const Construction = () => {
  ...
  const categories = ["Interior Finishes", "Building Construction", "Landscape Development"];
  ...
  const filteredImages = servicespicturesConstruction.filter(
  ...
  const serviceDetail =
    serviceDetailsConstruction[selectedCategory]?.fullText ||
  ...
  return (
    <div className="font-poppins text-white">
      ...
      <section
        ...
        style={{ backgroundImage: `url(${filteredImages[0]?.image || ""})` }}
      >
        <div className="absolute inset-0 bg-black/50 flex flex-col justify-center px-10 lg:px-24 text-white">
          ...
          <p className="max-w-2xl text-sm sm:text-lg">
            Delivering modern, safe, and efficient construction solutions, turning your ideas into reality with quality craftsmanship.
          </p>
        </div>
      </section>
      ...
      <div className="text-center mt-10 px-10 lg:px-24">
        ...
        <p className="text-gray-400 mt-5 mb-6">
          Delivering excellence across building construction, interior finishes, and landscape development.
        </p>
      </div>
        ...
        <div className="flex flex-col md:flex-row justify-center items-start space-x-0 md:space-x-10 lg:space-x-16">
          {categories.map((category, idx) => (
            ...
            >
              ...
              >
                <img
                  src={servicespicturesConstruction.find((img) => img.title === category)?.image}
                  alt={category}
              ...
              <h3 className="text-lg font-normal mt-4">{category}</h3>
      ...
      <section className="bg-transparent px-4 sm:px-10 lg:px-24 py-16 text-center">
        ...
        <p className="text-sm text-gray-300 mb-10">
          Explore our portfolio and discover detailed service insights across our core construction areas.
        </p>
      ...
      <section className="text-center mt-15 px-10 lg:px-24">
        <h2 className="text-3xl lg:text-4xl font-semibold mb-4 text-white">
          Talk to Us About Your Dream Project
        </h2>
        <p className="text-sm text-gray-300 mb-10">
          Let’s bring your vision to life with bespoke construction solutions tailored to you.
        </p>
